...
{
	case ".default":
		$APPLICATION->IncludeComponent('bitrix:mobile.crm.activity..default', '', array(
	...
	case "edit":
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				'CONTACT_SELECTOR_URL_TEMPLATE' => SITE_DIR.'mobile/crm/client/.default.php?entity=contact',
				'COMPANY_SELECTOR_URL_TEMPLATE' => SITE_DIR.'mobile/crm/client/.default.php?entity=company',
