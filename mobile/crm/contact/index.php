...
{
	case ".default":
		$APPLICATION->IncludeComponent("bitrix:mobile.crm.contact..default", "", array(
	...
	case "view":
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				"DEAL_LIST_URL_TEMPLATE" => SITE_DIR."mobile/crm/deal/?page=.default&contact_id=#contact_id#",
			)
		);
		break;
}
