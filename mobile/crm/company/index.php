...
{
	case ".default":
		$APPLICATION->IncludeComponent("bitrix:mobile.crm.company..default", "", array(
	...
	case "view":
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				"DEAL_LIST_URL_TEMPLATE" => SITE_DIR."mobile/crm/deal/?page=.default&company_id=#company_id#",
			)
		);
		break;
}
