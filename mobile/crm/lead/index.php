...
{
	case ".default":
		$APPLICATION->IncludeComponent("bitrix:mobile.crm.lead..default", "", array(
	...
	case "edit":
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				'PRODUCT_SELECTOR_URL_TEMPLATE' => SITE_DIR.'mobile/crm/product/?page=.default&list_mode=selector',
				'LEAD_VIEW_URL_TEMPLATE' => SITE_DIR.'mobile/crm/lead/?page=view&lead_id=#lead_id#'
			)
		);
		break;
	case "view":
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				'ACTIVITY_LIST_URL_TEMPLATE' => SITE_DIR.'mobile/crm/activity/.default.php?entity_type_id=#entity_type_id#&entity_id=#entity_id#',
				'ACTIVITY_EDIT_URL_TEMPLATE' => SITE_DIR.'mobile/crm/activity/edit.php?owner_type=#owner_type#&owner_id=#owner_id#&type_id=#type_id#',
				'COMMUNICATION_LIST_URL_TEMPLATE' => SITE_DIR.'mobile/crm/comm/.default.php?entity_type_id=#entity_type_id#&entity_id=#entity_id#&type_id=#type_id#',
				'EVENT_LIST_URL_TEMPLATE' => SITE_DIR.'mobile/crm/event/.default.php?entity_type_id=#entity_type_id#&entity_id=#entity_id#',
			)
		);
		break;
}
